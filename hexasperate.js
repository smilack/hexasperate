...
var $author$project$BestTimes$BestTimes = F6(
	function (small, medium, large, huge, _double, triple) {
		return {_double: _double, huge: huge, large: large, medium: medium, small: small, triple: triple};
	});
var $author$project$BestTimes$init = A6($author$project$BestTimes$BestTimes, _List_Nil, _List_Nil, _List_Nil, _List_Nil, _List_Nil, _List_Nil);
...
var $author$project$Puzzle$Double = {$: 'Double'};
var $author$project$Puzzle$Triple = {$: 'Triple'};
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Puzzle$cellsFor = function (size) {
	switch (size.$) {
		case 'Double':
			return _List_fromArray(
				[
...
var $author$project$HexGrid$custom = F3(
	function (zoom, centerPoint, axs) {
		return A3($author$project$HexGrid$HexGrid, zoom, centerPoint, axs);
	});
...
var $author$project$Puzzle$gridFor = function (size) {
	switch (size.$) {
		case 'Double':
			return A3(
				$author$project$HexGrid$custom,
				$author$project$Puzzle$zoomFor($author$project$Puzzle$Double),
				$author$project$Graphics$middle,
				$author$project$Puzzle$cellsFor($author$project$Puzzle$Double));
		case 'Triple':
			return A3(
				$author$project$HexGrid$custom,
				$author$project$Puzzle$zoomFor($author$project$Puzzle$Triple),
				$author$project$Graphics$middle,
				$author$project$Puzzle$cellsFor($author$project$Puzzle$Triple));
		default:
			return A3(
...
var $author$project$Main$initialModel = function (version) {
	return {
...
var $author$project$Main$init = function (version) {
	return _Utils_Tuple2(
		$author$project$Main$initialModel(version),
		$author$project$Main$getSvgDimensions);
};
...
var $author$project$BestTimes$maybeListDecoder = function (field) {
	var toList = function (mList) {
		if (mList.$ === 'Just') {
			var list = mList.a;
...
var $author$project$BestTimes$deserialize = function (json) {
	return A2(
		...
		A7(
			...
			$author$project$BestTimes$maybeListDecoder('small'),
			$author$project$BestTimes$maybeListDecoder('medium'),
			$author$project$BestTimes$maybeListDecoder('large'),
			$author$project$BestTimes$maybeListDecoder('huge'),
			$author$project$BestTimes$maybeListDecoder('double'),
			$author$project$BestTimes$maybeListDecoder('triple')),
		json);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'double',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, times._double)),
				_Utils_Tuple2(
				'triple',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, times.triple))
			]));
};
...
var $author$project$Puzzle$NoHoverInfo = function (a) {
	return {$: 'NoHoverInfo', a: a};
};
...
var $author$project$Hex$id = function (_v0) {
	var h = _v0.a;
	return h.id;
};
...
var $author$project$HexPositions$glideAll = F6(
	function (hexes, from, to, glideDelay, glideDuration, dict) {
		var ids = A2($elm$core$List$map, $author$project$Hex$id, hexes);
...
var $author$project$Hex$Hex = function (a) {
	return {$: 'Hex', a: a};
};
var $author$project$Hex$HexInfo = F3(
		...
		var wedges = A6(
			...
			A2(
				...
				A3(
					...
					coords.vi,
					coords.i)));
		return $author$project$Hex$Hex(
			A3(
				$author$project$Hex$HexInfo,
				id_,
				wedges,
				$author$project$StrUtil$simplePath(
...
var $author$project$Hex$matchingLabel = F2(
	function (index, _v0) {
		var wedges = _v0.a.wedges;
		var wedge = A2(
				...
				var knownWedges = A2(
					...
					F2(
						function (i, h) {
							return A2(
								$elm$core$Maybe$map,
								$author$project$Hex$matchingLabel(i),
								h);
						}),
					mNeighbors);
...
var $author$project$HexGrid$axialPoints = F2(
	function (zoom, ax) {
		return A2(
			$author$project$HexGrid$hexPoints,
			zoom,
			A2($author$project$HexGrid$toPoint, 20 * zoom, ax));
	});
...
var $author$project$HexGrid$toLine = F2(
	function (_v0, _v1) {
		var cx = _v0.a;
		var cy = _v0.b;
		var dx = _v1.a;
		...
		return A2(
			$elm$core$Basics$composeR,
			$elm$core$Basics$mul(m),
			$elm$core$Basics$add(cy - (cx * m)));
	});
var $author$project$HexGrid$hexContains = F2(
	function (_v0, _v1) {
		var x = _v0.a;
		var y = _v0.b;
		var i = _v1.i;
		...
		return (_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, i, ii, x)) > -1) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, ii, iii, x)) > -1) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, iii, iv, x)) > -1) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, iv, v, x)) < 1) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, v, vi, x)) < 1) && (_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, vi, i, x)) < 1)))));
	});
...
var $author$project$Graphics$sum = F2(
	function (_v0, _v1) {
		var x1 = _v0.a;
		var y1 = _v0.b;
		var x2 = _v1.a;
...
var $author$project$HexGrid$shiftPoints = F2(
	function (point, points) {
		return A2(
			$author$project$HexList$map,
			$author$project$Graphics$sum(point),
			points);
	});
var $author$project$HexGrid$cellAt = F2(
	function (point, grid) {
		var zoom = grid.a;
		var ctr = grid.b;
		var axs = grid.c;
		...
		var axialsAndPoints = A2(
			$elm$core$List$map,
			function (ax) {
				return _Utils_Tuple2(
					ax,
					A2($author$project$HexGrid$axialPoints, zoom, ax));
			},
			axs);
		var axialsAndOutlines = A2(
			$elm$core$List$map,
			$elm$core$Tuple$mapSecond(
				$author$project$HexGrid$shiftPoints(center)),
			axialsAndPoints);
		return A2(
			$elm$core$Maybe$map,
			$elm$core$Tuple$first,
			$elm$core$List$head(
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$elm$core$Tuple$second,
						$author$project$HexGrid$hexContains(point)),
					axialsAndOutlines)));
	});
...
var $author$project$HexPlacements$removeAll = F2(
	function (hexes, placements) {
		var fakePlacements = A2(
			...
			A2($elm$core$List$map, $author$project$Hex$id, hexes));
		return A2(
			$elm$core$Dict$diff,
			placements,
...
var $author$project$Puzzle$handleDrop = F3(
	function (draggedHexes, dropTarget, model) {
		handleDrop:
		while (true) {
			switch (dropTarget.$) {
				case 'NotDraggedYet':
					var returnTargets = dropTarget.a;
					return _Utils_update(
						model,
						{
				...
				case 'NoHoverInfo':
					var point = dropTarget.a;
					var _v1 = A2($author$project$HexGrid$cellAt, point, model.grid);
					if (_v1.$ === 'Just') {
						var ax = _v1.a;
						var $temp$draggedHexes = draggedHexes,
							$temp$dropTarget = $author$project$Puzzle$GridCell(ax),
							$temp$model = model;
						draggedHexes = $temp$draggedHexes;
						dropTarget = $temp$dropTarget;
						model = $temp$model;
						continue handleDrop;
					} else {
						var $temp$draggedHexes = draggedHexes,
							$temp$dropTarget = $author$project$Puzzle$OffGrid,
							$temp$model = model;
						draggedHexes = $temp$draggedHexes;
						dropTarget = $temp$dropTarget;
						model = $temp$model;
...
var $author$project$HexPositions$get = F2(
	function (hex, dict) {
		var _v0 = A2(
			...
			dict,
			$author$project$HexPositions$getPos(
				$author$project$Hex$id(hex)));
		var x = _v0.x;
		var y = _v0.y;
...
var $author$project$Hex$labels = function (_v0) {
	var wedges = _v0.a.wedges;
	return A2(
		$author$project$HexList$map,
		function ($) {
...
var $author$project$Hex$labelAt = F2(
	function (index, _v0) {
		var wedges = _v0.a.wedges;
		return A2(
			$author$project$HexList$get,
...
var $author$project$Puzzle$match = F3(
	function (neighbors, index, label) {
		...
		if (_v0.$ === 'Nothing') {
			...
			return _Utils_eq(
				label,
				A2($author$project$Hex$labelAt, index, hex));
		}
	});
			...
			var neighbors = A2(
				...
				$elm$core$Maybe$andThen(
					A2(
						...
						hexes)),
				neighborCoords);
			var labels = $author$project$Hex$labels(hex);
			return A2(
			...
			switch (msg.$) {
				...
				case 'MovePointer':
					...
					if (_v2.$ === 'NotDragging') {
						...
						var dropTarget = function () {
							var _v3 = model.dropTarget;
							switch (_v3.$) {
								case 'NotDraggedYet':
									var placements = _v3.a;
									return $author$project$Puzzle$NoHoverInfo(mousePos);
								case 'NoHoverInfo':
									return $author$project$Puzzle$NoHoverInfo(mousePos);
								default:
									var other = _v3;
						...
						return _Utils_Tuple2(
							A3(
								$author$project$Puzzle$updateDraggedHexes,
								mousePos,
								hexes,
								_Utils_update(
									model,
				...
				case 'StopDraggingHex':
					...
					if (_v5.$ === 'NotDragging') {
						...
						var newModel = A3($author$project$Puzzle$handleDrop, draggedHexes, model.dropTarget, model);
...
var $author$project$Main$getTouchCoord = function (event) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Graphics$middle,
		A2(
...
var $author$project$Main$viewVersion = function (version) {
	return $elm$core$String$isEmpty(version) ? $elm$html$Html$text('') : A2(
		$author$project$Main$viewText,
		'VERSION ' + version,
		_Utils_Tuple2(0.5, 5));
};
var $author$project$Main$viewAbout = F2(
	function (titleAnimation, version) {
		return _List_fromArray(
			[
				A2($author$project$Title$view, titleAnimation, $author$project$Title$about),
				$author$project$Main$viewVersion(version),
				A2(
				$author$project$Main$viewText,
...
var $author$project$Puzzle$previewGrids = {
	_double: A3(
		$author$project$HexGrid$custom,
		0.19,
		_Utils_Tuple2(180, 43.5),
		$author$project$Puzzle$cellsFor($author$project$Puzzle$Double)),
	huge: A3(
		$author$project$HexGrid$create,
		0.19,
		_Utils_Tuple2(180, 109),
		$author$project$Puzzle$rangeFor($author$project$Puzzle$Huge)),
	large: A3(
		$author$project$HexGrid$create,
		0.19,
		_Utils_Tuple2(60, 109),
...
var $author$project$HexGrid$viewHex = F3(
	function (mouseEvents, zoom, ax) {
		var points = A2($author$project$HexGrid$axialPoints, zoom, ax);
...
var $author$project$HexList$filter = F2(
	function (fn, list) {
		var filt = function (mA) {
			return A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Maybe$map, fn, mA)) ? mA : $elm$core$Maybe$Nothing;
		};
		return A2($author$project$HexList$map, filt, list);
	});
...
var $author$project$HexGrid$getOutline = F3(
	function (zoom, axGroup, grid) {
		...
		var getSegment = F2(
			function (pts, mSeg) {
				if (mSeg.$ === 'Just') {
					...
					return $elm$core$Maybe$Just(
						A2(
							$author$project$StrUtil$line,
							A2($author$project$HexList$get, i1, pts),
							A2($author$project$HexList$get, i2, pts)));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			});
		...
		var allPoints = A2(
			$elm$core$List$map,
			$author$project$HexGrid$axialPoints(zoom),
			axGroup);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$d(
				A3($author$project$HexGrid$getOutline, zoom, axs, grid))
			]),
		_List_Nil);
};
...
var $author$project$Puzzle$preview = function (size) {
	switch (size.$) {
		...
		case 'Double':
			return A3($elm$html$Html$Lazy$lazy2, $author$project$HexGrid$view, $author$project$Puzzle$previewMsgAttrs, $author$project$Puzzle$previewGrids._double);
		default:
			return A3($elm$html$Html$Lazy$lazy2, $author$project$HexGrid$view, $author$project$Puzzle$previewMsgAttrs, $author$project$Puzzle$previewGrids.triple);
	}
};
...
var $author$project$Puzzle$resume = function (size) {
	switch (size.$) {
		...
		case 'Double':
			return A3($elm$html$Html$Lazy$lazy2, $author$project$HexGrid$view, $author$project$Puzzle$previewMsgAttrs, $author$project$Puzzle$resumeGrids._double);
		default:
			return A3($elm$html$Html$Lazy$lazy2, $author$project$HexGrid$view, $author$project$Puzzle$previewMsgAttrs, $author$project$Puzzle$resumeGrids.triple);
	}
};
	...
	function (titleAnimation, puzzle) {
		...
		return _List_fromArray(
			[
				...
				$author$project$Main$viewMenuOption,
				'LARGE',
				_Utils_Tuple2(60, 110.5),
				$author$project$Main$CreatePuzzle($author$project$Puzzle$Large)),
				$author$project$Puzzle$preview($author$project$Puzzle$Huge),
				A3(
				$author$project$Main$viewMenuOption,
				'HUGE',
				_Utils_Tuple2(180, 110.5),
				$author$project$Main$CreatePuzzle($author$project$Puzzle$Huge)),
				$author$project$Puzzle$preview($author$project$Puzzle$Double),
				A3(
				$author$project$Main$viewMenuOption,
				'DOUBLE',
				_Utils_Tuple2(180, 45),
				$author$project$Main$CreatePuzzle($author$project$Puzzle$Double)),
				$author$project$Puzzle$preview($author$project$Puzzle$Triple),
				A3(
				$author$project$Main$viewMenuOption,
				'TRIPLE',
				_Utils_Tuple2(200, 77.5),
				$author$project$Main$CreatePuzzle($author$project$Puzzle$Triple)),
				$author$project$Main$viewBackButton($author$project$Main$TitleScreen)
			]);
	});
...
var $author$project$Puzzle$viewDraggedHex = function (_v0) {
	...
	return _Utils_Tuple2(
		...
		A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Lazy$lazy, $author$project$Hex$view, hex)
				])));
};
...
var $author$project$HexPositions$getLagged = F4(
	function (hex, index, count, dict) {
		var _v0 = _Utils_Tuple3(index, count, 0.5);
		var i = _v0.a;
		var n = _v0.b;
		var t = _v0.c;
		var arrive = (t * (n - i)) / n;
		...
		var _v1 = A2(
			...
			dict,
			A3(
				$author$project$HexPositions$getPosLagged,
				$author$project$Hex$id(hex),
				leave,
				arrive));
		var x = _v1.x;
...
var $author$project$Puzzle$getTouchInfo = F2(
	function (msg, event) {
		return A2(
			msg,
			$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$MainButton,
			A2(
				$elm$core$Maybe$withDefault,
				$author$project$Graphics$middle,
				A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Puzzle$getTouchInfo(
								$author$project$Puzzle$StartDraggingHex(hex)),
							$author$project$Puzzle$ForParent))
					]),
				_List_fromArray(
...
var $author$project$Puzzle$viewTimer = function (timer) {
	...
	return A2(
		...
		A2(
			$elm$core$List$cons,
			A4(makeText, 'right', -10, thousands, 1000),
			A4(
				$elm$core$List$map3,
				makeText('center'),
				xs,
...
var $author$project$BestTimes$view = function (_v0) {
	...
	var _double = _v0._double;
	var triple = _v0.triple;
	var x6 = ($author$project$Graphics$screen.w * 6) / 7;
	var x5 = ($author$project$Graphics$screen.w * 5) / 7;
	var x4 = ($author$project$Graphics$screen.w * 4) / 7;
	var x3 = ($author$project$Graphics$screen.w * 3) / 7;
	var x2 = ($author$project$Graphics$screen.w * 2) / 7;
	var x1 = ($author$project$Graphics$screen.w * 1) / 7;
	return A2(
		$elm$svg$Svg$g,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($author$project$BestTimes$viewListHeader, x1, 'SM'),
				A2($author$project$BestTimes$viewTimeList, x1, small),
				A2($author$project$BestTimes$viewListHeader, x2, 'MED'),
				A2($author$project$BestTimes$viewTimeList, x2, medium),
				A2($author$project$BestTimes$viewListHeader, x3, 'LG'),
				...
				A2($author$project$BestTimes$viewListHeader, x5, '2X'),
				A2($author$project$BestTimes$viewTimeList, x5, _double),
				A2($author$project$BestTimes$viewListHeader, x6, '3X'),
				A2($author$project$BestTimes$viewTimeList, x6, triple)
			]));
};
			...
			case 'AboutScreen':
				return _Utils_Tuple2(
					...
					A2(
						...
						A2($author$project$Main$viewAbout, options.titleAnimation, version)));
			case 'LicenseScreen':
				return _Utils_Tuple2(
					'license-screen',
					A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$Basics$composeR, $author$project$Main$getTouchCoord, $author$project$Main$MouseMove)),
