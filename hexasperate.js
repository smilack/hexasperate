...
var $author$project$HexGrid$hexContains = F2(
	function (_v0, _v1) {
		...
		return (_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, i, ii, x)) > 0) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, ii, iii, x)) > 0) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, iii, iv, x)) > 0) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, iv, v, x)) < 0) && ((_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, v, vi, x)) < 0) && (_Utils_cmp(
			y,
			A3($author$project$HexGrid$toLine, vi, i, x)) < 0)))));
	});
